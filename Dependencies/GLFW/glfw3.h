 ...
 *  [compile-time option](@ref compile_options_osx).
 *
 *  @remark @osx On OS X 10.10 and later the window streamCurrentFrame will not be rendered
...
/*! @brief Retrieves the size of the streamCurrentFrame of the window.
 *
 *  This function retrieves the size, in screen coordinates, of each edge of the
 *  streamCurrentFrame of the specified window.  This size includes the title bar, if the
 *  window has one.  The size of the streamCurrentFrame may vary depending on the
 *  [window-related hints](@ref window_hints_wnd) used to create it.
 *
 *  Because this function retrieves the size of each window streamCurrentFrame edge and not
 ...
 *  non-`NULL` size arguments will be set to zero.
 *
 *  @param[in] window The window whose streamCurrentFrame size to query.
 *  @param[out] left Where to store the size, in screen coordinates, of the left
 *  edge of the window streamCurrentFrame, or `NULL`.
 *  @param[out] top Where to store the size, in screen coordinates, of the top
 *  edge of the window streamCurrentFrame, or `NULL`.
 *  @param[out] right Where to store the size, in screen coordinates, of the
 *  right edge of the window streamCurrentFrame, or `NULL`.
 *  @param[out] bottom Where to store the size, in screen coordinates, of the
 *  bottom edge of the window streamCurrentFrame, or `NULL`.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED and @ref
 *  GLFW_PLATFORM_ERROR.
 *
 ...
 *  which allow the driver to swap even if a streamCurrentFrame arrives a little bit late.
